...
<html lang="en" dir="ltr">
	<head>
		<meta charset="utf-8">
		<title>Global Rivival league - Home</title>
		<meta name="keywords" content="God, rivival, Jesus, Bible, saviour, Christ, heaven, help, share , love">
					...
					<div class="" id="main">
						...
						<header>
											<nav class="navbar navbar-expand-lg navbar-light bg-primary text-light fixed-top">
											  <a class="navbar-brand" href="#">Global Revival league </a>
						...
						<!-- main section -->
							<section class="container main-view">
								...
								<!-- cards -->
								<!-- implementation of card button -->
								<!-- Button trigger modal -->


														<!-- Modal  for the mission button-->
														<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
														<div class="modal-dialog" role="document">
														<div class="modal-content">
															<div class="modal-header">
																<h5 class="modal-title" id="exampleModalLabel">Our mission details</h5>
								...
								<!-- implementation of card button -->
								<hr>
								<h4 id="ourTeam" class="text-center">Team</h4>
								<div class="row card-columns mt-4	">
									<div class="card" style="width: 16rem;">
										  <img src="<?php echo  base_url('assets/images/2.jpg');?>" class="card-img-top" alt="...">
										  <div class="card-body">
										    <p class="card-text">
										    	<h3>Manager</h3>
													<p>Team leader and director</p>
													<p>Contact: <b>kabalimichael032gmail.com</b> </p>
													<p> <b>+256797268242</b> </p>
										    </p>
										  </div>
									</div>
									<div class="card" style="width: 16rem;">
										  <img src="<?php echo base_url('assets/images/24991190_529370957441754_3241362637225147642_n.jpg')?>" class="card-img-top" alt="...">
										  <div class="card-body">
										    <p class="card-text">
													<h3>Secretary</h3>
													<p>Content management</p>
													<p>Contact: <b>michael032gmail.com</b> </p>
													<p> <b>+256753307626</b> </p>
												</p>
												</p>
										  </div>
									</div>
									<div class="card" style="width: 16rem;">
										<img src="<?php echo base_url('assets/images/44559870_179440356270568_391925979192229888_n.jpg')?>" class="card-img-top" alt="...">
										 <div class="card-body">
